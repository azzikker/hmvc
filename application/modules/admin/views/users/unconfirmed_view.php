...
<div id = "list_member" style="/*display: none;*/">  
    <article class="module width_full">
        <header><h3>Users Unconfirmed</h3></header>
...
<?php $user_id_hash = md5(time() . "" . $u_encrypt . "" . time() . "" . $u_decrypt) . "" . time() . "" . $u_encrypt; ?>
                <tr align="center">               
                    ...
                    <td>
                        <a onclick="return c_ask('Are you sure you want to confirm the selected record?')" href="<?php echo base_url(); ?>admin/admin_users/confirmUser/<?php echo $u_encrypt_count; ?>/<?php echo $user_id_hash; ?>"><img id="icn_confirm" src="assets/admin/images/icn_confirm.png" title="Confirm User Account"></a>
