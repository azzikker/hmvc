...
<!--Added tabs-->
                <ul class="tabs">
                    ...
                    <li><a href="<?php base_url()?>admin/admin_companies/trash_company_view">Trashed Company</a></li>
                </ul>
<!---->
        </header>
<?php else : ?>
...
<?php foreach($sql as $row) : ?>
    ...
    <?php if($page != "Company Reports") : ?>
        ...
        <?php if($this->session->userdata('user_level') == 0) : ?>
                                <a onclick="return c_ask('Are you sure you want to delete the selected record?')" href="<?php echo base_url(); ?>admin/admin_companies/deleteCompany/<?php echo $c_encrypt_count; ?>/<?php echo $company_id_hash; ?>"><img id="icn_trash" src="assets/admin/images/icn_trash.png" title="Delete Company"></a>
        <!--multi selectors-->
