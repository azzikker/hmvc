...
<?php ?>
        ...
        <div id="deal-info-bot">
            ...
            <a href="mobile/past_deals/<?php echo $dv->deal_hash ?>">
<?php if (strtolower($dv->deal_view_type) == "single deal"): ?>
<?php if($dv->deal_current_stock <> 0): ?>
                <div id="deal-info-bot-right">
                    <div>View<br />Details</div>
                </div>
<?php else: ?>
                <div id="deal-info-bot-right">
                    <div>View</div>
...
<div id="deal">
    ...
    <div id="deal-info">
    <a href="mobile/past_deals/<?php echo $dv->deal_hash ?>">
        <div id="deal-info-top" class="pastgroup">View Details</div>
    </a>
<?php if($dv->video_embed <> ""): ?>
        <div id="deal-info-bot" class="pastgroup" link="<?php echo htmlspecialchars($dv->video_embed) ?>">Watch Video</div>
<?php endif; ?>
    </div>
</div>
<!-- END OF DEAL -->
