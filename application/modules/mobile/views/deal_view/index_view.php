...
<?php endif ?>
        ...
        <div id="deal-info-bot">
            ...
            <a href="mobile/buys/<?php echo $dv->deal_hash ?>">
<?php if (strtolower($dv->deal_view_type) == "single deal"): ?>
...
<div id="etcbtn">
    <div id="etcbtn-sl">
        ...
        <span style="border:1px solid #CAD4E7; display:block; padding:1px; background:#eceef5; height: 17px; margin-right: 5px;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;">
            <fb:share-button href="<?php echo base_url(); ?>mobile/deal/<?php echo $this->uri->segment(3) ?>" class="meta">
                <meta property="og:title" content="<?php echo $dv->deal_view_title ?>!"/>
                <meta property="og:type" content="product"/>
                <meta property="og:url" content="<?php echo base_url(); ?>mobile/deal/<?php echo $this->uri->segment(3) ?>"/>
                ...
                <meta name="title" content="<?php echo $dv->deal_view_title ?>!" />
                <link rel="image_src" href="<?php echo base_url(); ?>assets/general/images/deals_gallery/optimize/<?php echo $dv->deal_image; ?>" />
                <link rel="target_url" href="<?php echo base_url(); ?>mobile/deal/<?php echo $this->uri->segment(3) ?>" />
            </fb:share-button> 
        </span>
        </div>
        <div id="etcbtn-sl-l">
            <iframe src="http://www.facebook.com/plugins/like.php?href=<?php echo base_url()."mobile/deal/".$this->uri->segment(3) ?>&layout=button_count&show_faces=false&width=100&action=like&amp;font&colorscheme=light&height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px;" allowTransparency="true"></iframe>
        </div>
    </div>
</div>
<!--START OF INFO-->
...
<?php if($dv->deal_current_stock <> 0): ?>
        <a href="mobile/buys/<?php echo $dv->deal_hash ?>">
        <div id="info-dbtn-vgin-box">
            <div id="info-dbtn-vgin"><span>VI</span>gorously <span>G</span>rab <span>IT</span></div>
        </div>
        </a>
<?php endif; ?>
    </div>
...
<div id="deal">
    ...
    <div id="deal-info">
        ...
        <div id="deal-info-bot">
            ...
            <a href="mobile/buys/<?php echo $dv->deal_hash ?>/<?php echo $this->uri->segment(4) ?>">
<?php if($dv->deal_current_stock <> 0): ?>
                <div id="deal-info-bot-right">
                    <div><span>VI</span>gorously</div>
                    <div><span>G</span>rab <span>IT</span>!</div>
...
<div id="etcbtn">
    <div id="etcbtn-sl">
        ...
        <script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script>
        <span style="border:1px solid #CAD4E7; display:block; padding:1px; background:#eceef5; height: 17px; margin-right: 5px;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;">
            <fb:share-button href="<?php echo base_url(); ?>mobile/deal/<?php echo $this->uri->segment(3) ?>/<?php echo $this->uri->segment(4) ?>" class="meta">
                <meta property="og:title" content="<?php echo $dv->deal_view_title ?>!"/>
                <meta property="og:type" content="product"/>
                <meta property="og:url" content="<?php echo base_url(); ?>mobile/deal/<?php echo $this->uri->segment(3) ?>/<?php echo $this->uri->segment(4) ?>"/>
                <meta property="og:description" content="<?php echo $dv->deal_view_statement ?>" />
                <meta property="og:image" content="<?php echo base_url(); ?>assets/general/images/deals_gallery/optimize/<?php echo $dv->deal_image; ?>"/>
                <meta name="title" content="<?php echo $dv->deal_view_title ?>!" />
                <link rel="image_src" href="<?php echo base_url(); ?>assets/general/images/deals_gallery/optimize/<?php echo $dv->deal_image; ?>" />
                <link rel="target_url" href="<?php echo base_url(); ?>mobile/deal/<?php echo $this->uri->segment(3) ?>/<?php echo $this->uri->segment(4) ?>" />
            </fb:share-button> 
        </span>
        </div>
        <div id="etcbtn-sl-l">
            <iframe src="http://www.facebook.com/plugins/like.php?href=<?php echo base_url()."mobile/deal/".$this->uri->segment(3) ?>/<?php echo $this->uri->segment(4) ?>&layout=button_count&show_faces=false&width=100&action=like&amp;font&colorscheme=light&height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px;" allowTransparency="true"></iframe>
        </div>
    </div>
</div>
<!--START OF INFO-->
...
<div id="deal">
    ...
    <div id="deal-info">
        ...
        <div id="deal-info-bot">
            ...
            <a href="mobile/deal/<?php echo $dv->deal_hash ?>/<?php echo $dh; ?>">
<?php if($dv->deal_current_stock <> 0): ?>
                <div id="deal-info-bot-right">
                    <div><span>VI</span>gorously</div>
                    <div><span>G</span>rab <span>IT</span>!</div>
